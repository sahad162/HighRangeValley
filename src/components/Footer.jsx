    ...
    <footer className="bg-[#030703] font-satoshi text-white/60 relative overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 py-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-6">
          <span className="font-satoshi text-light text-white/80">
            Highrangevalley @ 2025 All rights reserved
          </span>
          <div className="flex space-x-12 text-lg">
            <a
              href="https://youtube.com/@highrangevalley6934?si=wPRMy8rGIzR6B5qZ"
              target="_blank"
              rel="noopener noreferrer"
              className="cursor-pointer"
            >
              <i className="fa-brands fa-youtube text-white hover:text-red-500"></i>
            </a>
             <a
              href="https://www.instagram.com/highrange_valley?igsh=MWMwdGF0MHNhOXk2MA=="
              target="_blank"
              rel="noopener noreferrer"
              className="cursor-pointer"
            >
            <i className="cursor-pointer fa-brands fa-instagram text-white hover:text-pink-500"></i></a>

              <a
              href="https://www.facebook.com/share/1GYZCsEJv4/"
              target="_blank"
              rel="noopener noreferrer"
              className="cursor-pointer"
            >
            <i className="cursor-pointer fa-brands fa-facebook-f text-white hover:text-blue-500"></i></a>
