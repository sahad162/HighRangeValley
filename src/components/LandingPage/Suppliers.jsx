    ...
    <section className="relative py-20  font-satoshi bg-[#F7F9F3] ">
      ...
      <div className="absolute top-16 left-2 xl:left-10">
        <img
          src="/leaf.png"
          alt="leaf"
          className="hidden sm:block w-20 mb-3  "
        />
      </div>
      <div className="absolute right-0 top-0  ">
        <img src="/top right.png" alt="leaf" className=" w-50 sm:w-60 mb-3  " />
      </div>
      <div className="supplier-cont px-10 lg:px-20 mt-10 mb-10 flex flex-wrap gap-10 justify-between sm:justify-center items-center sm:items-start">
        <div className="flex flex-col gap-10 lg:gap-20  flex-1">
          <h2 className="text-3xl mt-2 sm:mt-0 sm:text-4xl md:text-[3rem] font-[500] font-satoshi-medium  text-[#141414] leading-tight tracking-wider">
        ...
        <div className="flex flex-col gap-8     w-full sm:p-0   lg:w-[50%]   ">
          <p className="text-base xl:text-[1.3rem] font-light text-[#222] text-justify">
