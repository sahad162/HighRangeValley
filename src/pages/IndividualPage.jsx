...
import { ChevronRight } from "lucide-react"; // for icons
...
const IndividualPage = () => {
  return (
      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 bg-white p-8 rounded-2xl ">
        ...
        <div className="flex flex-col  justify-center  lg:w-[90%]">
          ...
          <div className="mt-16 flex flex-col  gap-4">
            ...
            <button className="flex-1 border border-[#1A6F2F]  text-transparent bg-clip-text bg-gradient-to-r from-[#88B158] to-[#146B2D] py-3 rounded-full font-medium transition">
              <span className="font-satoshi-medium">Connect us</span>
            </button>
          </div>

            <div className="mt-20 lg:mt-30 xl:mt-40 flex flex-col sm:flex-row md:flex-col lg:flex-row gap-6">
    ...
    <div className="flex items-center gap-3 ">
      ...
      <div>
        <p className="text-xs uppercase text-black font-satoshi-medium">Phone</p>
        <p className="text-sm font-medium font-satoshi">+91 9847 017714</p>
      </div>
    </div>
    ...
    <div className="flex items-center gap-3 ">
      ...
      <div>
        <p className="text-xs uppercase text-black font-satoshi-medium">Email</p>
